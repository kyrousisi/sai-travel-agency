...
/**
 * Aggregate : it is used when message is sent to three agencies Easy_Tickets, Cheap_Tickets, and Business_Tickets
 */
public class EasyCheapBusinessBookingAggregate implements BookingAggregate {
