...
/**
 * Aggregate : it is used when message is sent to two agencies Easy_Tickets and Business_Tickets
 */
public class EasyBusinessBookingAggregate implements BookingAggregate {
